...
class EstadoDeResultados extends React.Component {
    ...
    grafica_barras($lista_establecimientos) {
        const $lista_conceptos = ["VENTAS NETAS", "COSTO DE VENTAS", "UTILIDAD EN OPERACION", "GASTOS DE OPERACION", "UTILIDAD NETA OPERACIONAL", "IMPUESTOS ISR", "IMPUESTOS PTU 10%", "UTILIDAD NETA","RETIROS UTILIDAD"];
...
const VistaTablaPrincipal = ({ lista, evento, Totales, eventoEstablecimiento}) => {
    ...
    const lista_conceptos = ["VENTAS NETAS", "COSTO DE VENTAS", "UTILIDAD EN OPERACION", "TRUPUT DE OPERACION", "GASTOS DE OPERACION", "UTILIDAD NETA OPERACIONAL", "TRUPUT NETA OPERACIONAL", "IMPUESTOS ISR", "IMPUESTOS PTU 10%", "UTILIDAD NETA", "TRUPUT NETA","RETIROS UTILIDAD","UTILIDAD NETA DESPUES DE RETIRO"];
