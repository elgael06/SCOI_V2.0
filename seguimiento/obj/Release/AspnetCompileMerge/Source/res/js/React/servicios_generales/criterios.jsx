class Vista_Criterios extends React.Component{
    constructor(props) {
        super(props);
...
<div className="cuerpo_tabla">
    <Tabla cavecera={[<h5>Folio</h5>,<h5>Criterios</h5>,<h5>Estatus</h5>,<h5>Borrar</h5>]}
    ...
    guardar() {
        if (this.state.edicion) {
            const url = "/servicios/servicios_generales/conexiones.asmx/servicios_guardar_actualizar_criterio_ckl";
            fetch(url, {
                method: 'POST',
