            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            "button",
                            { type: "button", className: "close", "data-dismiss": "modal", onClick: this.props.cerrar },
                            "×"
                        ),
                        this.props.cavecera || React.createElement(
                            "h3",
                            null,
                            "Sin datos"
                        )
                    ...
                    React.createElement(
                        "div",
                        { className: "modal-body", style: estylo_cuerpo_modal },
                        this.props.cuerpo || React.createElement(
                            "h3",
                            null,
                            "Sin datos"
                        )
    ...
    _createClass(Modal_con_tabla, [{
        ...
        value: function render() {
            ...
            var cuerpo_modal = [React.createElement(Btn_seleccion, { guardar: this.props.guardar,
                ...
                evento: this.props.evento_filtrar }), React.createElement(
                "div",
                { className: "tabla_matriz" },
                React.createElement(Tabla, { cavecera: this.props.cavecera_tabla,
