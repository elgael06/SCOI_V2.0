<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/main.Master" CodeBehind="scoi_res_ckl.aspx.vb" Inherits="seguimiento.scoi_res_ckl" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        ...
        var acceso_menu= conexion_ajax("servicios/accesoServ.asmx/checar_acceso_subMenu",{"id_usuario":id_usuario,"folio_sub_menu":20});
        if (!acceso_menu)
    ...
    <div id="padre"  style="">
        <div id="area_cabecera">
            ...
            <div class="btnf"> <input type="button" title="GUARDAR." id="btNuevo" class="btncabeza" value="EXCEL" onclick=" guardar_tabla_datos_a_excel()" /></div>
            <div class="btnf"><input type="button" title="RESULTADOS." id="btResultados"  onclick="llenar_tabla_res()" value="RESULTADOS" class="btncabeza" /></div>
            <div class="btnf"><input type="button" title="DESHACER." id="btDeshacer"  onclick=" remover_datos_tabla()" value="DESHACER" class="btncabeza" /></div>
            <div class="btnf"><input type="button" title="TERMINAR." id="btGuardar"  value="TERMINAR" class="btncabeza" /></div>
            <br />
            <section >
