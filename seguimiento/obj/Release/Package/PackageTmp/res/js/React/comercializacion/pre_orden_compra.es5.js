    ...
    ********************************************/
    ...
    _createClass(Cargar_inventario, [{
        ...
        value: function render() {
            return React.createElement("div", { className: "contenedor_carga_inventasrio", style: { "text-align": "center" } }, React.createElement("section", null, React.createElement("h3", null, " Pre-orden de Compra de Verduras."), " "), React.createElement("div", null, React.createElement("input", { type: "button", value: " Cargar Existencia.", className: "btn btn-info", onClick: this.Conexion_i.bind(this) })));
        }
...
var Tabla_comparativa = (function (_React$Component2) {
    ...
    **************************************************/
    ...
    _createClass(Tabla_comparativa, [{
        key: "render",
        value: function render() {
            return React.createElement("div", null, React.createElement(Btn_cotizar, { datos: this.inventario }), React.createElement(Btn_generar_orden_compra, { datos: this.inventario }), React.createElement("h3", null, "Cotizador Pre-orden De Compra."), React.createElement("div", { className: "cotizador" }, React.createElement("table", { className: "table table-bordered" }, React.createElement("thead", null, React.createElement("tr", null, React.createElement("th", { className: "info", style: { "text-align": "center" }, colspan: "6" }, "PRODUCTOS"), React.createElement("th", { className: "success", style: { "text-align": "center" }, colspan: this.proveedores.length }, " PROVEEDORES")), this.cavecera_tabla()), React.createElement("tbody", null, this.manejo_datos()))));
        }
    }, {
        key: "cavecera_proveedores",
        value: function cavecera_proveedores() {
            var r = this.proveedores.map(function (proveedor) {
                return React.createElement("th", { className: "success", style: { "text-align": "center" } }, proveedor.nombre);
            });
            return r;
        }
    }, {
        ...
        value: function datos_proveedores(producto) {
            ...
            var r = this.proveedores.map(function (proveedor) {
                return React.createElement("td", { style: { "text-align": "right" } }, " $ ", _this3.precios.find(function (p) {
        ...
        value: function manejo_datos() {
            ...
            var r = this.inventario.map(function (producto) {
                return React.createElement("tr", null, React.createElement("td", { style: { "text-align": "center" } }, producto.codigo), React.createElement("td", null, producto.nombre), React.createElement("td", { style: { "text-align": "center" } }, producto.existencia), React.createElement("td", { style: { "text-align": "center" } }, producto.pedido), React.createElement("td", { style: { "text-align": "center" } }, producto.total_venta), React.createElement("td", { style: { "text-align": "right" } }, " $ ", producto.u_costo), _this4.datos_proveedores(producto.codigo));
            });
            return r;
        }
    }, {
        ...
        value: function cavecera_tabla() {
            return React.createElement("tr", { style: { "text-align": "center" } }, React.createElement("th", { className: "info" }, "Codigo"), React.createElement("th", { className: "info" }, "Descripcion"), React.createElement("th", { className: "info" }, "Existencia"), React.createElement("th", { className: "info" }, "Pedido"), React.createElement("th", { className: "info" }, "Total Venta"), React.createElement("th", { className: "info" }, "Ultimo Costo"), this.cavecera_proveedores());
        }
    }]);
...
var Btn_cotizar = (function (_React$Component3) {
    ...
    _createClass(Btn_cotizar, [{
        ...
        value: function cavecera() {
            ReactDOM.render(React.createElement("h3", null, "Capturar Precio."), document.getElementById("cavecera"));
        }
    }, {
        key: "cuerpo",
        value: function cuerpo() {
            ReactDOM.render(React.createElement("div", null, React.createElement("div", { className: "input-group" }, React.createElement("span", { className: "input-group-addon" }, React.createElement("i", { className: "glyphicon glyphicon-tasks" }, " Proveedor : ")), this.lista_proveedores()), React.createElement("div", { className: "input-group" }, React.createElement("span", { className: "input-group-addon" }, React.createElement("i", { className: "glyphicon glyphicon-shopping-cart" }, " Producto : ")), this.lista_productos()), this.btn_agregar()), document.getElementById("contenido"));
        }
    }, {
        key: "lista_proveedores",
        value: function lista_proveedores() {
            var r = this.datos[0].proveedores.map(function (proveedor) {
                return React.createElement("option", { value: proveedor }, proveedor);
            });
            return React.createElement("select", { className: "form-control" }, r);
        }
    }, {
        key: "lista_productos",
        value: function lista_productos() {
            var r = this.datos.map(function (productos) {
                return React.createElement("option", { value: productos.nombre }, productos.nombre);
            });
            return React.createElement("select", { className: "form-control" }, r);
        }
    }, {
        ...
        value: function btn_agregar() {
            return React.createElement("div", { style: { "display": "inline-block", "width": "50%" } }, React.createElement("div", { className: "input-group" }, React.createElement("span", { className: "input-group-addon" }, React.createElement("i", { className: "glyphicon glyphicon-usd" }, " Precio : ")), React.createElement("input", { className: "form-control", type: "text", min: "0", rigth: true, placeholder: "0.00", onChange: function onChange(e) {
                    console.log("z");
