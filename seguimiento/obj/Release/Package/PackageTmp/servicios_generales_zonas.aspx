<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/main.Master" CodeBehind="servicios_generales_zonas.aspx.vb" Inherits="seguimiento.servicios_generales_zonas" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h3>Zonas De Revicion De Servicios</h3>
    <div id="container">
    ...
    <script type="text/jsx;harmony=true" src="res/js/React/servicios_generales/zonas.jsx?V1.0" ></script>
</asp:Content>
